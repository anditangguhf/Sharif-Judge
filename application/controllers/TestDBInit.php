...
/**
*  @file TestDBInit, used to initialize database for first time use.
*  Codes are based on mjnaderi/Sharif-Judge Install.php file.
*/

defined('BASEPATH') OR exit('No direct script access allowed');

class TestDBInit extends CI_Controller {
